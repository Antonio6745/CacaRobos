                ...
                <div class="panel-heading" role="tab" id="headingOne">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            ...
                            <center style="color: white; padding-left: 0px;" > Denúncia - 1 </center>
                        </a>
                    </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body animated zoomOut">
                        <center></br><p><b><span style="color:#28a745">Endereço da denúncia: </span></b> https://www.facebook.com/
                         <br>
                          <br>
                         <b><span style="color:#28a745">Descrição da denúncia: </span></b> Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos, e vem sendo utilizado desde o século XVI, quando um impressor desconhecido pegou uma bandeja de tipos e os embaralhou para fazer um livro de modelos de tipos
                            <br>
                          <br>

                        <b><span style="color:#28a745">Total de avaliação: </span></b> 50 avaliações
                            <br>
                          <br>
