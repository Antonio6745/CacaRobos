...
<div class="collapse navbar-collapse" id="navbarResponsive">
  <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
      <a class="nav-link" href="gerenManager">
                          ...
                          <div class="panel-heading" role="tab" id="headingOne">
                              <h4 class="panel-title">
                                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                      ...
                                      <center style="color: white; padding-left: 0px;" > ${valuer.name } </center>
                                  </a>
                              </h4>
                          </div>
                          <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                              <div class="panel-body animated zoomOut">
                                  <center></br><p><b><span style="color:#28a745">Email para contato: </span></b> ${valuer.username } 
                                  <br>
                                  <br>
                                  ...
                                  <b><span style="color:#28a745">Total de avaliação: </span></b> 50 avaliações
                                      <br>
                                    <br>
                                  <b><span style="color:#28a745">Status: </span></b> Ativo</p>

                                  <button type="button" class="btn btn-success">Excluir Voluntario</button>
                              </div>
                          </div>
                      </div>
                    </div>
