    ...
    <div class="container-fluid">
      ...
      <!-- Area Chart Example-->
       <ul class="navbar-nav ml-auto">
        ...
        <div class="container">  
        <div class="row">
        <c:forEach items="${listInactiveValuers}" var="listInactive">
            <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
              <div class="card h-100">
                <div class="card-body">
                  <h4 class="card-title">
                    <p><b>Avaliador ${listInactive.name}</p></b></h4>
                  <p align="left"><p><b><span style="color:#28a745">Avaliador desde: </span></b> 
                             <br>
                              <br>
                             <b><span style="color:#28a745">Email: </span></b> ${listInactive.login.username }
                                <br>
                              <br>
                            ...
                            <b><span style="color:#28a745">Votos "Não é Robô": </span></b> 30
                                <br>
                              <br>
                            <a href="deleteValuer?id=${listInactive.id }"><button type="button" class="btn btn-success">Rejeitar</button></a>
                            <a href="aproveValuer?id=${listInactive.id }"><button type="button" class="btn btn-success">Aceitar</button></a>
